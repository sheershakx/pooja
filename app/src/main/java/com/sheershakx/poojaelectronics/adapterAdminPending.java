...
public class adapterAdminPending extends RecyclerView.Adapter<adapterAdminPending.ViewHolder> {
    ...
    public adapterAdminPending(ArrayList<String> clientiid, ArrayList<String> uid, ArrayList<String> itemtype, ArrayList<String> date, ArrayList<String> name, ArrayList<String> status, ArrayList<String> astatus, ArrayList<String> mstatus) {
